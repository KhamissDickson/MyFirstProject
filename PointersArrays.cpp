...
int main(){
    ...
    *pPointer = 10; // assign a value to the first element
    ...
    /*increment the pointer using the pointer arithmetic to asign the address of the second element to the pointer*/
    pPointer++;
    ...
    *pPointer = 40; // assign a value to the fourth element
    ...
    /*assign a value to the element using indirection and pointer arithmetic*/
    *(pPointer+4) = 50;
